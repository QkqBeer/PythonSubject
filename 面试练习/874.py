...
#                     if x == obstacles[j][0]:
#                         if obstacles[j][1] > y and obstacles[j][1] <= newy:
#                             newy = obstacles[j][1] - 1
#                         if obstacles[j][1] < y and obstacles[j][1] >= newy:
#                             newy = obstacles[j][1] + 1
#                 y = newy
#             elif y == newy: #左右移动
#                 for j in range(len(obstacles)):
#                     if y == obstacles[j][1]:
#                         if obstacles[j][0] > x and obstacles[j][0] <= newx:
#                             newx = obstacles[j][0] - 1
#                         if obstacles[j][0] < x and obstacles[j][0] >= newx:
#                             newx = obstacles[j][0] + 1
#                 x = newx
#             print(x, y)
